"""Regression gate for consolidated-v1a fragment split."""
...
from evrp_fragments_consolidated_v1.pipeline_v1a import run_solver, summary_to_json
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run consolidated-v1a c101C6_2 regression gate.")
...
def main() -> None:
    ...
    print("consolidated_v1a fragment split regression gate passed")

"""Run consolidated-v1c callback-split solver from the repository root."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run consolidated-v1c callback-split EVRP solver.")

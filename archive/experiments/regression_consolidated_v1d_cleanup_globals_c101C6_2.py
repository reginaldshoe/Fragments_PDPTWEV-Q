"""Regression gate for consolidated-v1d cleanup globals."""
...
from evrp_fragments_consolidated_v1.pipeline_v1d import run_solver, summary_to_json
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run consolidated-v1d c101C6_2 regression gate.")
...
def main() -> None:
    ...
    print("consolidated_v1d cleanup globals regression gate passed")

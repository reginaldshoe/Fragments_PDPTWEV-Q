"""Run consolidated-v1e remove-legacy-runtime solver from the repository root."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run consolidated-v1e remove-legacy-runtime EVRP solver.")

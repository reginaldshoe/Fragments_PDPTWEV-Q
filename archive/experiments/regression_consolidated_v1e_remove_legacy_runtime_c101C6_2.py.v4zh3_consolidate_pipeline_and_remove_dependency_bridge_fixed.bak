"""Regression gate for consolidated-v1e remove legacy runtime."""
...
from evrp_fragments_consolidated_v1.pipeline_v1e import run_solver, summary_to_json
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run consolidated-v1e c101C6_2 regression gate.")
...
def main() -> None:
    ...
    for key in (
        "base_paths", "restricted_raw", "restricted_dedup", "restricted_meta",
        "restricted_undominated", "extended_raw", "extended_dedup", "extended_meta",
        "extended_undominated", "selected_arc_ids", "status",
    ):
    ...
    print("consolidated_v1e remove legacy runtime regression gate passed")

"""Run consolidated-v1b master-split solver from the repository root."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run consolidated-v1b master-split EVRP solver.")

"""Regression gate for consolidated-v1c callback split."""
...
from evrp_fragments_consolidated_v1.pipeline_v1c import run_solver, summary_to_json
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run consolidated-v1c c101C6_2 regression gate.")
...
def main() -> None:
    ...
    print("consolidated_v1c callback split regression gate passed")

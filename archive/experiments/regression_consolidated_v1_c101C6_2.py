"""Compare consolidated-v1 against the known c101C6_2 parity gate."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run consolidated-v1 c101C6_2 regression gate.")
...
def main() -> None:
    ...
    for key in (
        "source_sha256", "base_paths", "restricted_raw", "restricted_dedup", "restricted_meta",
    ...
    print("consolidated_v1 c101C6_2 regression gate passed")

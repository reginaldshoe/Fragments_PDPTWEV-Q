"""Run consolidated-v1a fragment-split solver from the repository root."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run consolidated-v1a fragment-split EVRP solver.")
